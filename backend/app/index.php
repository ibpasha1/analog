<?php
/*
Copyright (c) Cosyne Analog 2017 - 2018 - Author Ibrahim Pasha
*/
include 'db.php';
session_start();
...
$result = $mysqli->query("SELECT * FROM analog_users WHERE email='$email'") or die ($mysqli->error);
...
{
    $email     = isset($_POST['email'])     ? $_POST['email']     : '';
    $result = $mysqli->query("SELECT * FROM analog_users WHERE email='$email'");
