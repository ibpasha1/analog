...
<html>
      ...
      <div id="stuff">
         <div id="app">
            <div class="center">
               <ul>
                  ...
                  <li>
                     ...
                     <div id="slidecontainer">
                        <input type="range" min="1" max="6" id="font_size" class="slider" id="myRange">
                  ...
                  <li>
                     background-color:
                     <select id="bg_color"  class="field-select">
                        <option value="">Saved</option>
                        <option value="gray">gray</option>
                        <option value="white">white</option>
                        <option value="cray">light cyan</option>
                        <option value="alice blue">alice blue</option>
                        <option value="honeydrew">honeydrew</option>
                        <option value="lavender">lavender</option>
                        <option value="mintcream">mintcream</option>
                        <option value="light blue">light blue</option>
                        <option value="light steel blue"></option>
                     </select>
                  </li>
               </ul>
               <p id="caption"></p>
               ...
               <ul>
                  <li><input placeholder="" id="micro_bio" type="text" class="validate"></li>
                  <li><input placeholder="" id="school"    type="text" class="validate"></li>
                  <li><input placeholder="" id="education" type="text" class="validate"></li>
                  <li><input placeholder="" id="age"       type="text" class="validate"></li>
                  <li><input placeholder="" id="height"    type="text" class="validate"></li>
                  <li><input placeholder="" id="pol_view"  type="text" class="validate"></li>
                  <li><input placeholder="" id="fav_color" type="text" class="validate"></li>
                  <li><input placeholder="" id="econ"      type="text" class="validate"></li>
               </ul>
               <hr>
   ...
   <script>
      $(document).ready(function() {
        ...
        document.getElementById("font_type").placeholder          = font_type;
        document.getElementById("font_size").placeholder          = font_size;
        document.getElementById("bg_color").placeholder           = bg_color;
        document.getElementById("micro_bio").placeholder          = micro_bio;
        document.getElementById("school").placeholder             = school;
        document.getElementById("education").placeholder          = education;
        document.getElementById("age").placeholder                = age;
        document.getElementById("height").placeholder             = height;
        document.getElementById("pol_view").placeholder           = pol_view;
        document.getElementById("fav_color").placeholder          = fav_color;
        document.getElementById("econ").placeholder               = econ;
        document.getElementById("solid_sk").placeholder           = solid_sk;
        document.getElementById("mid_sk").placeholder             = mid_sk;
        document.getElementById("light_sk").placeholder           = light_sk;
        document.getElementById("curr_pos").placeholder           = curr_pos;
        document.getElementById("project_info").placeholder       = project_info;
        document.getElementById("resume").placeholder             = resume;
        document.getElementById("github_username").placeholder    = github_username;
        document.getElementById("personal_site").placeholder      = personal_site;
        document.getElementById("linkedin_url").placeholder       = linkedin_url;
        document.getElementById("insta_username").placeholder     = insta_username;
